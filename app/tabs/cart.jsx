...
<Image source={require('../../assets/images/1.jpg')} className="m-2" style={{height:300,width:300,borderRadius:10}}/>
...
<View className="flex-row">
  ...
  <View className="flex-col justify-between">
<Image source={require('../../assets/images/3.jpg')} className="m-2" style={{height:300,width:300,borderRadius:10}}/>
